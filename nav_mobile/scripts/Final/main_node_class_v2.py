...
class greenbot_safe_control():
    def __init__(self):
        ...
        self.safe_vel_pub = rospy.Publisher("/safe_vel", Twist, queue_size=25)
        ...
        # TODO FIX NAMES
        self.platform_status_pub = rospy.Publisher("/platformStatus", Bool, queue_size=1)
        # TODO FIX COMMENTS
    ...
    def stop_robot(self):
        ...
        self.fw_running = False
        self.safe_vel_pub.publish(self.vel_msg.cmd_vel)    
    ...
    def auto_stop_pause(self):
        ...
        # slikaj
        rospy.sleep(3)
        rospy.logdebug("Vision completed. Continue.")
        self.sensor_done = True
    ...
    def ctrl_to_communication(self):
            while not self.ctrl_c:
                ...
                self.led_pub.publish(self.platform_status)
                self.rate.sleep()
