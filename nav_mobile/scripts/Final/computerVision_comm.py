...
TCP_PORT = 9000 # Port to send data to
TCP_IP = "192.168.65.55" # Adress to send data to (vision system)
...
class TCPClient():
    def __init__(self):
        ...
        self.vel_sub = rospy.Subscriber("/cmd_vel", greenhouse_cmd, self.prog_callback)
    ...
    def prog_callback(self, prog_topic):
        ...
        # print(prog_topic.data)
        if prog_topic.mode == 1:
            self.program = 1
            print("Debug: Setting program StopNGo")
        elif prog_topic.mode == 0:
            self.program = 2
            print("Debug: Setting program MoveNScan")
        else:
            self.program = 0
